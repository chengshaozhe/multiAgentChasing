...
def main():
    ...
    trajectoryFixedParameters = {'priorType': 'uniformPrior', 'perceptNoise':1e-1, 'wolfPolicy':'NNPolicy', 
    ...
    trajectoryParameters = {'sheepPolicy': 'sampleNNPolicy'}
    #trajectoryParameters = {'sheepPolicy': 'NNPolicy'}
    ...
    [chaseTrial(trajectory) for trajectory in np.array(trajectories)[[2]]]
