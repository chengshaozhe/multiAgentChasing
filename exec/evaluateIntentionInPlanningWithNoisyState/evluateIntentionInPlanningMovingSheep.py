...
class SampleTrjactoriesForConditions:
    ...
    def __call__(self, parameters):
        print(parameters)
        perceptNoise = parameters['perceptNoise']
...
def main():
    ...
    manipulatedVariables['perceptNoise'] = [1e1, 2e1, 4e1, 8e1, 1.6e2, 3.2e2]
    ...
    composePercept = lambda perceptNoise : lambda hypothesisNextState, nextState: scipy.stats.multivariate_normal.pdf(
    ...
    getCalTransitionsLikelihood = lambda perceptNoise: [CalTransitionLikelihood(getOwnState, transit, composePercept(perceptNoise)) for getOwnState in getOwnStates]
