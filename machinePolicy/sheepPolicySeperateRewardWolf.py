...
if __name__ == '__main__':
    ...
    # sheep_states_all = list(it.product(sheep_state, repeat=2))
    ...
    for noise in [0]:
        ...
        for sheep_states in sheep_states_all:
            ...
            to_sheep_reward = ft.partial(
                distance_mean_reward, goal=sheep_states[1], unit=1)
    ...
    # save value
        ...
        prefix = 'noise' + str(noise) + 'SheepWolfSeperateReward' + 'Gird' + str(env.nx)
